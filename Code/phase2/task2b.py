...
basePath='C:\\Khadyu\\ASU\\Fall 2023\\Multimedia & Web Databases\\Project\Phase2\\cse515-project'
def task2b(query_image_id, query_image_file, k,category_names):
    ...
    myTrainedmodel.load_state_dict(torch.load(basePath+'\\Code\\TrainedModels\\resnetMod101.pkl' ,map_location=torch.device('cpu')))
