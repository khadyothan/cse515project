...
basePath='D:\\Project Multimedia\\new_phase2_repo\\cse515project'
def task2b(query_image_id, query_image_file, k,category_names):
    ...
    myTrainedmodel = resnet50(pretrained=False)
    myTrainedmodel.fc = nn.Linear(2048, 101)
    myTrainedmodel.load_state_dict(torch.load(basePath+'\\Code\\TrainedModels pkls\\resnetMod101.pkl' ,map_location=torch.device('cpu')))
