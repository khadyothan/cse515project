...
from phase1 import print_top_k_images
...
def similarkimages(query_image_data, query_feature_space, k):
    ...
    for doc in collection.find():
        ...
        distance_cm_dict[db_image_id] = l2_distance(query_cm_vector, db_cm_vector)
    ...
    if query_feature_space == "color_moments":
        print_top_k_images.print_images(images_cm_display, query_feature_space, target_size=(224, 224))
    elif query_feature_space == "hog":
        print_top_k_images.print_images(images_hog_display, query_feature_space, target_size=(224, 224))
    elif query_feature_space == "resnet50_layer3":
        print_top_k_images.print_images(images_layer3_display, query_feature_space, target_size=(224, 224))
    elif query_feature_space == "resnet50_avgpool":
        print_top_k_images.print_images(images_avgpool_display, query_feature_space, target_size=(224, 224))
    elif query_feature_space == "resnet50_fc":
        print_top_k_images.print_images(images_fc_display, query_feature_space, target_size=(224, 224))
