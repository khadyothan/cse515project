import sys
sys.path.append('C:\\Users\\admin\\Desktop\\ASU\Multimedia\\rohit-sb\\Code\\')
...
def LS2(query_image_data, query_feature_model, k, K):
    ...
    query_image_vector = np.ravel(query_image_vector)
    feature_model_data_matrix = np.loadtxt(f"C:\\Users\\admin\\Desktop\\ASU\Multimedia\\rohit-sb\\Code\\dimensionality_reduction\\data_matrix_{feature_model_data_file_path}.csv", delimiter=',')
