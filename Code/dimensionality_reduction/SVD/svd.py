...
def calculateImageIDWeightPairs(feature_descriptor_ls, feature_descriptor, k, type): 
    ...
    with open(f"C:\Khadyu\ASU\Fall 2023\Multimedia & Web Databases\Project\Phase2\cse515-project\Code\image_id_weight_pairs\SVD\svd_{feature_descriptor}_{k}_wp_{type}.txt", "w") as file:
